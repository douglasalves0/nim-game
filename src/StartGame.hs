...
main :: IO()
    ...
    não possuo mais desejos para lhe oferecer, entretanto gostaria de lhe propor um desafio e em troca você ganhará todas as criptomoedas que estiverem disponíveis. 
